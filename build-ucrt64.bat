...
gcc -o bin/rayDE.exe src/main.c -I"%RAYLIB_PATH%/src" -L"%RAYLIB_PATH%/src" -march=native -mtune=native -lraylib -lopengl32 -lgdi32 -lwinmm -std=c11 -Wall -Wextra -Werror -Wshadow -Wformat=2 -Wno-unused-variable -Wno-unused-function -Wno-unused-label
